...
<div class="container">
    ...
    <div class="row g-5 g-xl-8">
        ...
        <div class="col-xl-6">
            <div class="card h-100 shadow-sm hover-elevate-up cursor-pointer vendor-diklat-card">
                <div class="card-body p-5 rounded-4"
                    style="background: linear-gradient(135deg, #009ef7 0%, #0077cd 100%)">
                    <div class="d-flex flex-column">
                        <div class="text-white fw-bold fs-5 mb-3">Status Diklat</div>
                        <div class="d-flex flex-column gap-3">
                            <div class="d-flex justify-content-between align-items-center">
                                <span class="text-white-50">Total Diklat</span>
                                <span class="text-white fw-bold">{{ number_format($diklatSummary->total_diklat)
                                    }}</span>
                            </div>
                            <div class="d-flex justify-content-between align-items-center">
                                <span class="text-white-50">Diklat Selesai</span>
                                <span class="text-white fw-bold">{{ number_format($diklatSummary->completed_diklat)
                                    }}</span>
                            </div>
                            <div class="d-flex justify-content-between align-items-center">
                                <span class="text-white-50">Diklat Akan Datang</span>
                                <span class="text-white fw-bold">{{ number_format($diklatSummary->upcoming_diklat)
                                    }}</span>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-xl-6">
            <div class="card h-100 shadow-sm hover-elevate-up">
                <div class="card-body p-5 rounded-4"
                    ...
                    <div class="d-flex flex-column">
                        <div class="text-white fw-bold fs-5 mb-3">Ringkasan Pembayaran</div>
                        <div class="d-flex flex-column gap-3">
                            <div class="d-flex justify-content-between align-items-center">
                                <span class="text-white-50">Total Nilai Kontrak</span>
                                <span class="text-white fw-bold">Rp {{ number_format($paymentSummary->total_cost, 0,
                                    ',', '.') }}</span>
                            </div>
                            <div class="d-flex justify-content-between align-items-center">
                                <span class="text-white-50">Sudah Dibayar</span>
                                <span class="text-white fw-bold">Rp {{ number_format($paymentSummary->total_paid, 0,
                                    ',', '.') }}</span>
                            </div>
                            <div class="d-flex justify-content-between align-items-center">
                                <span class="text-white-50">Sudah Tertagih (Belum Dibayar)</span>
                                <span class="text-white fw-bold">Rp {{ number_format($paymentSummary->total_billed, 0,
                                    ',', '.') }}</span>
                            </div>
                            <div class="d-flex justify-content-between align-items-center">
                                <span class="text-white-50">Belum Tertagih</span>
                                <span class="text-white fw-bold">Rp {{ number_format($paymentSummary->total_unbilled, 0,
                                    ',', '.') }}</span>
                            </div>
                        </div>
                    </div>
        ...
        <!-- Simplified stats cards for PIC bidang -->
        <div class="col-xl-3 col-md-6">
            <div class="card shadow-sm hover-elevate-up">
                <div class="card-body p-5 rounded-4"
                    style="background: linear-gradient(135deg, #009ef7 0%, #0077cd 100%)">
                    <div class="d-flex flex-column">
                        <div class="text-white fw-bold fs-5 mb-3">Total Diklat</div>
                        <div class="d-flex align-items-center">
                            <span class="text-white fs-2x fw-bold me-2">{{ $diklatCount }}</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card shadow-sm hover-elevate-up">
                <div class="card-body p-5 rounded-4"
                    style="background: linear-gradient(135deg, #50cd89 0%, #3aa163 100%)">
                    <div class="d-flex flex-column">
                        <div class="text-white fw-bold fs-5 mb-3">Total Peserta</div>
                        <div class="d-flex align-items-center">
                            <span class="text-white fs-2x fw-bold me-2">{{ $employeeCount }}</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card shadow-sm hover-elevate-up">
                <div class="card-body p-5 rounded-4"
                    ...
                    <div class="d-flex flex-column">
                        <div class="text-white fw-bold fs-5 mb-3">Total Anggaran</div>
                        <div class="d-flex align-items-center">
                            <span class="text-white fs-2x fw-bold me-2">Rp {{ number_format($totalApprovedBudget, 0,
                                ',', '.') }}</span>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card shadow-sm hover-elevate-up">
                <div class="card-body p-5 rounded-4"
                    ...
                    <div class="d-flex flex-column">
                        <div class="text-white fw-bold fs-5 mb-3">Diklat Selesai</div>
                        <div class="d-flex align-items-center">
                            <span class="text-white fs-2x fw-bold me-2">{{
                                $participantDetails->where('status_monitoring', 'Selesai')->count() }}</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card shadow-sm">
                <div class="card-header bg-light border-0 py-5">
                    <h3 class="card-title align-items-start flex-column">
                        ...
                        <span class="text-muted mt-1 fw-semibold fs-7">Status pembayaran diklat berdasarkan
                            pelaksanaan</span>
                    </h3>
                </div>
                <div class="card-body">
    ...
    <div class="card shadow-sm mt-5">
        <div class="card-header border-0 pt-6">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label fw-bold fs-3 mb-1">Daftar Diklat Area {{ auth()->user()->area->name }}</span>
            </h3>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                <table id="kt_datatable" class="table table-row-bordered table-row-dashed gy-4">
                    <thead>
                    ...
                    <tbody>
                        @foreach($participantDetails as $diklat)
                        <tr>
                            <td>{{ $diklat->name }}</td>
                            <td>
                                <span class="badge badge-light-primary">{{ $diklat->diklat_type }}</span>
                            </td>
                            <td>{{ \Carbon\Carbon::parse($diklat->estimate_start_date)->format('d M Y') }}</td>
                            <td>{{ number_format($diklat->count_of_participant) }}</td>
                            <td>Rp {{ number_format($diklat->total_cost, 0, ',', '.') }}</td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
    ...
    {{-- <div class="card shadow-sm">
        <div class="card-header border-0 pt-6">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label fw-bold fs-3 mb-1">Daftar Diklat</span>
            </h3>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                <table id="kt_datatable" class="table table-row-bordered table-row-dashed gy-4">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <span
                                    class="badge badge-light-{{ $diklat->status_monitoring == 'Selesai' ? 'success' : 'warning' }}">
                                    {{ $diklat->status_monitoring }}
                                </span>
                            </td>
                            <td>Rp {{ number_format($diklat->total_cost, 0, ',', '.') }}</td>
                        </tr>
...
<div class="modal fade" tabindex="-1" id="vendorDiklatModal">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Detail Diklat</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="table-responsive">
                    <table class="table table-row-bordered gy-5 gs-7">
                        <thead>
                            <tr class="fw-bold fs-6 text-gray-800 border-bottom border-gray-200">
                                <th>Nama Diklat</th>
                                <th>Jenis Diklat</th>
                                <th class="text-end">Tanggal Mulai</th>
                                <th class="text-end">Tanggal Selesai</th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach($participantDetails as $detail)
                            <tr>
                                <td>{{ $detail->name }}</td>
                                <td>{{ $detail->diklat_type }}</td>
                                <td class="text-end">{{ Carbon\Carbon::parse($detail->estimate_start_date)->format('d M
                                    Y') }}</td>
                                <td class="text-end">{{ Carbon\Carbon::parse($detail->estimate_end_date)->format('d M
                                    Y') }}</td>
                            </tr>
                            @endforeach
                        </tbody>
...
<script>
    $(document).ready(function() {
        ...
        $('select[name="year_start"], select[name="year_end"], select[name="diklat_type"]').on('change', function() {
            ...
            window.location.href = "{{ route('dashboard') }}?" + $.param({
                ...
                $('.vendor-diklat-card').click(function() {
            $('#vendorDiklatModal').modal('show');
        });

            @if(auth()->user()->role_id !== 2)
        // Initialize charts and modals only for non-vendor users
    ...
    var chartData = [
    {
        ...
        "value": {{ $sudahDibayar }},
        "percent": {{ $sudahDibayar > 0 ? round(($sudahDibayar / ($sudahDibayar + $sudahDilaksanakanSudahTagih + $sudahDilaksanakanBelumTagih + $belumDilaksanakan)) * 100, 2) : 0 }}
    },
    {
        "category": "Sudah dilaksanakan, sudah tertagih, belum terbayar",
        "value": {{ $sudahDilaksanakanSudahTagih }},
        "percent": {{ $sudahDilaksanakanSudahTagih > 0 ? round(($sudahDilaksanakanSudahTagih / ($sudahDibayar + $sudahDilaksanakanSudahTagih + $sudahDilaksanakanBelumTagih + $belumDilaksanakan)) * 100, 2) : 0 }}
    },
    {
        "category": "Sudah dilaksanakan belum tertagih atau pelatihan dalam proses pelaksanaan",
        "value": {{ $sudahDilaksanakanBelumTagih }},
        "percent": {{ $sudahDilaksanakanBelumTagih > 0 ? round(($sudahDilaksanakanBelumTagih / ($sudahDibayar + $sudahDilaksanakanSudahTagih + $sudahDilaksanakanBelumTagih + $belumDilaksanakan)) * 100, 2) : 0 }}
    },
    {
        "category": "Pelatihan Belum dilaksanakan (belum tertagih)",
        "value": {{ $belumDilaksanakan }},
        "percent": {{ $belumDilaksanakan > 0 ? round(($belumDilaksanakan / ($sudahDibayar + $sudahDilaksanakanSudahTagih + $sudahDilaksanakanBelumTagih + $belumDilaksanakan)) * 100, 2) : 0 }}
    }
];

    // Column Chart initialization
...
var legend = chart.children.push(
    am5.Legend.new(root, {
        ...
        y: am5.percent(50),
        layout: root.verticalLayout,
        marginLeft: 30,              // Tambah margin
        paddingRight: 15,
        width: am5.percent(35),      // Set specific width
...
legend.labels.template.setAll({
    ...
    fontWeight: "400",
    fill: am5.color("#3F4254"),
    maxWidth: 200,                   // Tambah maxWidth
    oversizedBehavior: "wrap",       // Ganti ke wrap untuk text wrapping
    lineHeight: 1.2                  // Tambah line height untuk text yang wrap
});

        // Set up legend markers
