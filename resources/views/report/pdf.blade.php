        ...
        <div class="">
            ...
            <div class="mb-6">
                ...
                <table>
                    ...
                    <tr class="p-3">
                        <td class="p-3" style="width: 200px; background-color: #0BB7AF">Rata-rata Nilai Pre-Test</td>
            ...
            <div class="mb-6">
                ...
                @if($score5)
                    ...
                    <p>Untuk setiap rupiah yang dikeluarkan dalam pelatihan, pemberi kerja mendapatkan kembali sebesar <span class="text-primary">Rp. {{ $score5->hasilroti }}</span> dalam bentuk manfaat dari <span class="text-primary">{{ implode(',', $score4Impacts) }}</span></p>
                @endif
            </div>
        </div>
    ...
    <script>
        ...
        var report = function () {
            const level_1_reaction = () => {
                ...
                var height2 = parseInt(KTUtil.css(element, 'height2'));
